...
public interface IExtensibleBlock {
    EnumProperty<ExtensionType> EXTENSION_TYPE = EnumProperty.create("extension_type", ExtensionType.class);

    default ExtensionType getExtensionType(Level level, BlockPos pos) {
    ...
    enum ExtensionType implements StringRepresentable {
        BASE,
        EXTENSION,
        TIP;
